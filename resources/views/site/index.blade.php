    ...
    <div class="col-md-9">
        ...
        <div class="section home-users">
            <div class="title col-md-12">
              <h5 class="mb-2">Heigh Recomanded Designers</h5>
          </div>
          ...
          <ul class="users-list clearfix">
              <li>
                ...
                <div class="users-list-name">Alexander Pierce</div>
            </a>
        </li>
        <li>
            <a href="#">
            ...
            <div class="users-list-name"> Norman </div>
        </a>
    </li>
    <li>
        <a href="#">                      
          ...
          <div class="users-list-name">Jane</div>
      </a>
  </li>
  <li>
    <a href="#">                      
    ...
    <div class="users-list-name">John</div>
</a>
</li>
<li>
    <a href="#">
    ...
    <div class="users-list-name">Alexander</div>
</a>
</li>
<li>
    <a href="#">
    ...
    <div class="users-list-name">Sarah</div>
</a>
</li>
<li>
    <a href="#">
      ...
      <div class="users-list-name">Nora</div>
  </a>
</li>
<li>
    <a href="#">
      ...
      <div class="users-list-name">Nadia</div>
  </a>
</li>
</ul>
